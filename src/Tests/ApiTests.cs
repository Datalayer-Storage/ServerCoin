...
{
    private const ulong RESERVE_AMOUNT = 300000001;
    ...
    public async Task ListCoins()
    {
        ...
        var coins = await serverCoinFactory.GetServerCoins("26632ad912845e6f77714ca0996b21eb647803162dd444275ab5c09bea9426ea");
